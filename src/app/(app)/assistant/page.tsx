...
export default function AssistantPage() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      content: 'Noen is wired into the Command Center foundation. Once the server API key/env is set, I can read your app snapshot and coach from it. done',
    },
  ]);
      ...
      <section className="assistant-shell">
        ...
        <section className="assistant-chat-card">
          <div className="assistant-chat-header">
            ...
            <span className="assistant-status">Level 3 foundation</span>
          </div>
